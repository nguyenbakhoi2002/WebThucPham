...
namespace WebThucPham.Controllers
{
    public class CheckoutController : Controller
    {
        ...
        public IActionResult Index(string returnUrl = null)
        {
            ...
            ViewData["lsTinhThanh"] = new SelectList(_context.Locations.Where(x => x.Levels == 1).OrderBy(x => x.LocationId).ToList(), "LocationId", "Name");
        ...
        public IActionResult Index(MuaHangVM muaHang)
        {
            ...
            if (taikhoanID != null)
            {
                ...
                catch
                {
                    ...
                    ViewBag.GioHang = cart;
                    _notyfService.Error("vui lòng điền đầy đủ thông tin");
                    return View(model);
                }
            ...
            try
            {
                //để ý cái này, rất hay báo lỗi null
